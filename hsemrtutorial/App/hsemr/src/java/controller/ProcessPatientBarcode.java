 ...
 */
@WebServlet(name = "ProcessPatientBarcode", urlPatterns = {"/ProcessPatientBarcode"})
public class ProcessPatientBarcode extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (patientBarcode.equals(patientBarcodeInput)) {
            ...
            session.setAttribute("patientBarcode", patientBarcode);
            session.setAttribute("active", "medication");
            session.setAttribute("error", "Wrong patient! Please verify and rescan");
            response.sendRedirect("viewPatientInformation.jsp");
        }
    }

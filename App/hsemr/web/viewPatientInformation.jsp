...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function ()
            {
            $('#load_viewInvestigations').load('viewInvestigations.jsp').fadeIn("slow");
            }, 10000); 
        </script>
                ...
                <div class="large-centered large-11 columns">
                    ...
                    <div class="tabs-content">
                        ...
                        <div class="<% if (active != null && active.equals("reports")) {
                           ...
                           <div id="load_viewInvestigations"> <%@ include file="viewInvestigations.jsp" %></div>
                        ...
                        <div class="<% if (active != null && active.equals(
                            ...
                            <%@ include file="viewMedication.jsp" %>
                        </div>
                        <!--END OF MEDICATIONS-->
                        ...
                        <div class="<% if (active != null && active.equals(
                            ...
                            <div id="load_notes"> <%@ include file="viewMultidisciplinaryNotes.jsp" %></div>
                            <%--<%@ include file="viewMultidisciplinaryNotes.jsp" %>--%>
                        </div>
                        ...
                        <div class="<% 
                            ...
                            <%@ include file="viewDocuments.jsp" %>

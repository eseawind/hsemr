                        ...
                        <%
                            ...
                            if(lecScenarioList == null || lecScenarioList.size() == 0){
                                ...
                                for(String lecActivatedScenario: lecScenarioList){%>
                                    <%=lecActivatedScenario%><br>  
                                <%}
                            }
                        %>
                        <br>
                        <label><strong>Activate Case For Lecturer</strong>
                        <select name = "lecturerToActivateCase">
                            ...
                            <%
                                ...
                                for(Lecturer lec: lecturerList){
                                    %>
                                    <option value = "<%=lec.getLecturerID()%>"><%=lec.getLecturerID()%></option>
